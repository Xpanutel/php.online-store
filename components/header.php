	...
	<div class="container">
		...
		<nav class="main-menu" >
			<ul>
				...
				<li><a href="register.php"><img src="/img/register.png" alt="регистрация" style="width: 35px; margin: 0px 15px;"></a></li>
				<li><a href="login.php"><img src="/img/login.png" alt="авторизация" style="width: 35px; margin: 0px 15px;"></a></li>
				<?php } ?>
